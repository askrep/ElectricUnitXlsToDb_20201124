...
public class UnitRecyclerViewAdapter extends RecyclerView.Adapter<UnitRecyclerViewAdapter.ViewHolder> {
    ...
    public UnitRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.unit_title);
            mContentView = (TextView) view.findViewById(R.id.unit_description);
        }
